    ...
    return (
        <div className='border-black border-2 projectCard'>
            ...
            <div className='projectImageContainer'>
                <img src={bb1SS} alt="Bucket Battles Screenshot 1" className='projectImage'/>
                <img src={bb2SS} alt="Bucket Battles Screenshot 2" className='projectImage'/>
                <img src={bb3SS} alt="Bucket Battles Screenshot 3" className='projectImage'/>
                <img src={bb4SS} alt="Bucket Battles Screenshot 4" className='projectImage'/>
            </div>
