...
export const ContactMeForm = () => {
    ...
    return (
        <form ref={form} onSubmit={sendEmail} className='contactMeFormContainer p-2'>
            <div className='text-2xl m-2'>Send me a message! <br/> It will automatically deliver straight to my email.</div>
